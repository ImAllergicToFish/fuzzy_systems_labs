...
FISnew.input(1).mf(4).params(1) = param(7);
FISnew.input(2).mf(1).params(1) = param(8);
FISnew.input(2).mf(2).params(1) = param(9);
FISnew.input(2).mf(3).params(1) = param(10);
FISnew.input(2).mf(3).params(1) = param(11);

% Коэффициенты конццентрации термов выходных переменных
FISnew.output(1).mf(1).params(1) = param(12);
FISnew.output(1).mf(2).params(1) = param(13);
FISnew.output(1).mf(3).params(1) = param(14);
FISnew.output(1).mf(4).params(1) = param(15);


% коорд.максимумв некотор.термов входных переменных     
FISnew.input(1).mf(2).params(2) = param(16);
FISnew.input(2).mf(2).params(2) = param(17);

% коорд.максимумв некотор.термов выходных переменных 
FISnew.output(1).mf(1).params(2) = param(19);
FISnew.output(1).mf(2).params(2) = param(20);
FISnew.output(1).mf(3).params(2) = param(21);
FISnew.output(1).mf(4).params(2) = param(22);
